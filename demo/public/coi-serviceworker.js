...
// Re-applies COOP/COEP headers via a service worker so a static host (GitHub Pages) becomes
// cross-origin isolated → SharedArrayBuffer is available → wllama runs multi-threaded (and
// transformers.js/whisper faster). On first visit the page reloads once to take effect.
