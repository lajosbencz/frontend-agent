...
A generic English **web/front-end agent** built on **LiquidAI LFM2.5-230M**, small enough to run
**entirely in the browser** (edge / local inference via wllama, no server-side model). It doesn't
